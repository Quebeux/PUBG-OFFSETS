...
namespace Offsets
{
	public class UHudAlwaysOn_C
	{
		...
		public const int Border_1 = 0x0250;

		///<summary>UBP_AliveHumansInfoWidget_C *</summary>
		public const int BP_AliveHumansInfoWidget_145 = 0x0258;

		///<summary>UBP_AlivePlayerInfoWidget_C *</summary>
		public const int BP_AlivePlayerInfoWidget = 0x0260;

		///<summary>UBP_AliveZombiesInfoWidget_C *</summary>
		public const int BP_AliveZombiesInfoWidget_98 = 0x0268;

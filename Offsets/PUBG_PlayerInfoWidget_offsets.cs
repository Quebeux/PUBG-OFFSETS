...
namespace Offsets
{
	public class UPlayerInfoWidget_C
	{
		...
		public const int Border_1 = 0x0268;

		///<summary>UButton *</summary>
		public const int Button_1 = 0x0270;

		///<summary>UHorizontalBox *</summary>
		public const int HorizontalBox_2 = 0x0278;

		///<summary>USizeBox *</summary>
		public const int HPGaugeSizeBox_Hori = 0x0280;

		///<summary>UImage *</summary>
		public const int IconImage = 0x0288;

		///<summary>UButton *</summary>
		public const int KickButton = 0x0290;

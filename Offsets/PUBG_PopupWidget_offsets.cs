...
namespace Offsets
{
	public class UPopupWidget_C
	{
		...
		public const int ButtonCancel = 0x0250;

		///<summary>UButton *</summary>
		public const int ButtonOK = 0x0258;
		...
		///<summary>EPopupStyle</summary>
		public const int SavePopupStyle = 0x02B8;

...
namespace Offsets
{
	public class UInventoryWidget_C
	{
		...
		public const int A_ButtonHelpText = 0x02D0;

		///<summary>UTextBlock *</summary>
		public const int B_ButtonHelpText = 0x02D8;

		///<summary>UInventoryListBaseWidget_C *</summary>
		public const int Backpack = 0x02E0;

		///<summary>USizeBox *</summary>
		public const int Backpack_SizeBox = 0x02E8;

		///<summary>UBorder *</summary>
		public const int Border_2 = 0x02F0;

		///<summary>UButton *</summary>
		public const int btn_time = 0x02F8;

		///<summary>UButton *</summary>
		public const int btn_type = 0x0300;

		///<summary>UHorizontalBox *</summary>
		public const int ButonAHelpBox = 0x0308;

		///<summary>UButton *</summary>
		public const int Button_1 = 0x0310;

		///<summary>UButton *</summary>
		public const int Button_2 = 0x0318;
